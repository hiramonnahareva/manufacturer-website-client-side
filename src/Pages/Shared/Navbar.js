...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 text-[16px] px-8 sticky top-0 z-10">
            ...
            {
                user ? <li><NavLink to='/login'><button onClick={() => logOut()} className='btn btn-outline btn-primary mx-2'>SignOut</button></NavLink></li> : <li><NavLink to='/login'><button className='btn btn-outline btn-primary mx-2'>Login</button></NavLink></li>
            }
